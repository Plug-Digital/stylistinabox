...
<table class="form-table">
	<tr valign="top">
		...
		<td>
			<input type="text" class="regular-text" name="company_name" id="company_name" value="<?php echo $form->companyName; ?>" maxlength="<?php echo $form_data::COMPANY_NAME_LENGTH; ?>">
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="regular-text" name="prod_desc" id="prod_desc" value="<?php echo $form->productDesc; ?>" maxlength="<?php echo $form_data::PRODUCT_DESCRIPTION_LENGTH; ?>">
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="regular-text" name="open_form_button_text" id="open_form_button_text" value="<?php echo $form->openButtonTitle; ?>" maxlength="<?php echo $form_data::OPEN_BUTTON_TITLE_LENGTH; ?>">
